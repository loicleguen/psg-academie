  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-15" onSubmit={handleSubmit}>
          {error && (
          ...
          <div className="block mx-auto flex justify-center">
            <Link to="/register" className="group relative w-50 flex justify-center py-2 px-4 border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50">
              Créer un compte
            </Link>
          </div>
        </form>
