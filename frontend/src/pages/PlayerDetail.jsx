...
export default function PlayerDetail() {
  ...
  const [activeTab, setActiveTab] = useState('info'); // 'info', 'stats', 'medical'
  ...
  // Filter players by same position for comparison
  const getFilteredPlayers = () => {
    ...
    return allPlayers.filter(name => {
      ...
      // TODO: filtrer par position une fois qu'on a l'info de tous les joueurs
      return true;
    });
  };
            ...
            {activeTab === 'medical' && (
              <div className="space-y-6">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Antécédents médicaux</h3>
                  <p className="text-gray-600">Cette section sera disponible prochainement</p>
                  <p className="text-sm text-gray-500 mt-4">Historique des blessures, consultations médicales, etc.</p>
                </div>
              </div>
            )}
          </div>
